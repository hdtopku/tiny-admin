...
import AssignProductModal from '../newgoods/AssignProductModal.vue';
import PcDataList from '../newgoods/PcDataList.vue';
import MobileDataList from '../newgoods/MobileDataList.vue';
import {deleteById, execQuery, getAllHotGoodsIds, assignGoods, updateRecord} from '@/api/sms/hotGoods.ts';
...
const openAssignProductModal = (record: any) => {
  assignProductModalRef.value?.openModal(record, getAllHotGoodsIds);  // Use optional chaining to handle undefined modalRef
}
